...
const loginLink = document.querySelector('[data-testid="go-to-login"]');
if (loginLink && qs('redirect')) {
  loginLink.href = `/login.html?redirect=${encodeURIComponent(qs('redirect'))}`;
}
